...
func (c *simpleBankClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/simple_bank.SimpleBank/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simpleBankClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/simple_bank.SimpleBank/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SimpleBank_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simple_bank.SimpleBank/CreateUser",
	}
...
func _SimpleBank_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simple_bank.SimpleBank/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SimpleBank_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "simple_bank.SimpleBank",
	...
	Metadata: "simple-bank.service.proto",
}
